    ...
    <section className="container py-16 md:py-24">
      <div className="grid lg:grid-cols-5 gap-10 items-start">
        ...
        <div className="lg:col-span-2 lg:sticky lg:top-28">
          <div className="text-xs uppercase tracking-[0.2em] text-primary mb-3">Live crowd feed</div>
          <h2 className="font-display text-4xl md:text-5xl font-bold leading-tight mb-6">
            Real bettors. <br />
            <span className="italic text-gradient-gold">Real money.</span><br />
            Real time.
          </h2>
          <p className="text-muted-foreground leading-relaxed mb-8">
            Every reported bet feeds the crowd intelligence. See where the smart money is flowing
            from <span className="text-foreground">Winner</span>, <span className="text-foreground">Bet365</span>,
            and others — within seconds of the click.
          </p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-[10px] text-muted-foreground tabular ml-auto">{bet.timeAgo} ago</span>
                  </div>
                  <div className="text-sm text-muted-foreground truncate">
                    Bet on <span className="text-foreground font-semibold">{bet.pick}</span> · {bet.game}
                  </div>
                </div>
